...
const EditPurchasePage = () => {
    ...
    const {isLoading, apiData, serverErr} = useFetch(`/api/v1/purchases/purchase/${id}/update`)
    ...
    const handleSubmit = (e) => {
        ...
        fetch(`/api/v1/purchases/purchase/${id}/update`, {
            method: 'POST',
            headers: {
    ...
    useEffect(() => {
        if (apiData) {
            setProducts(prevState => ({
                ...
                allSelected: apiData.purchase.products.map(product => {
                    const p = {
            ...
            setSuppliers(prevState => ({
                ...
                selected: {
                    id: apiData.purchase.supplier.id,
                    name: apiData.purchase.supplier.name,
                    phone: apiData.purchase.supplier.phone,
                    street: apiData.purchase.supplier.street,
                    city: apiData.purchase.supplier.city,
                    state: apiData.purchase.supplier.state,
                    zip: apiData.purchase.supplier.zip
                }
            }))
            setStores(prevState => ({
                ...prevState,
                ...
                selected: {
                    name: apiData.purchase.store.name,
                    id: apiData.purchase.store.id
                }
            }))
            setStaff(apiData.purchase.staff)
            setDate(apiData.purchase.date)
        }
    }, [apiData])
    ...
    return (
        <div className='page edit-purchase'>
            <MainNavbar />
